...
class RDTLayer(object):
    ...
    def deliver_data(self):
        ...
        # YOUR CODE HERE:
        #self.dataReceived = []
        finalsort = dict(sorted(self.dictReceived.items()))
        print(finalsort)
    ...
    def getCumAck(self):
        ...
        for key in self.dictReceived:
            ...
            #print("HERE IS THE SELF.DICT::::::::::::::::::::::::::::::::::::::::::::", self.dictReceived[key])
            if key + self.DATA_LENGTH not in self.dictReceived.keys():

                return key + self.DATA_LENGTH
    ...
    def manageSegmentTimeouts(self):
        ...
        for key1 in selfDictSent:
            if counterForRec == 0:
                continue
            for key2 in self.dictReceived.keys():
