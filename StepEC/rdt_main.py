...
outOfOrder = True    # <--- Change this to True in Step 3
dropPackets = True   # <--- Change this to True in Step 4
delayPackets = True  # <--- Change this to True in Step 4
dataErrors = True    # <--- Change this to True in Step 5
